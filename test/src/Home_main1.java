...
public class Home_main1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Home_main1 frame = new Home_main1();
	...
	public Home_main1() {
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\JY\\eclipse-workspace\\Choice_help\\img\\choice.PNG"));
